...
#include"fonts.h"
//GLCD FontName : Tempus_Sans_ITC8x8
//GLCD FontSize : 8 x 8
/*

Font Link : https://github.com/dhepper/font8x8

This font need to be changed or method to parse this font need to be changed . The suggested appraoch would be to change the font inspite of adding new method or maybe the first approach 
which so ever is found feasible at that moment . 
...
const uint8_t font_2[] = 
{
     ...
     0x00, 0x0C, 0x0C, 0x00, 0x00, 0x0C, 0x0C, 0x06,   // U+003B (// , this should be ;)
