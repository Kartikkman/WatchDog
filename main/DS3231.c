...
char * bcd_char(uint8_t *arr,int length_arr)
{
 ...
 // Function which converts the BCD no into Integer ( For Example : BCD NO : 2,3 to 23 )
...
// Function which obtains the time from DS3231 ( Calls the raw I2C functions & receives the Data )
...
// Function to Update the Time stores inside the RTC ( DS3231 )  ( Calls the raw I2C functions & sends the Data which needs to be written )
